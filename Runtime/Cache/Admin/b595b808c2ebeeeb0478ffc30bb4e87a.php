...
<body>
    ...
    <div id="indexMain" class="index-main">
       <!-- 插件块 -->
       <div class="container-span top-columns cf" style="margin-top:30px;">
    <dl class="show-num-mod">
        <a href="<?php echo U('user/index');?>">
        <dt><i class="count-icon user-count-icon"></i></dt>
        <dd>
            <strong><?php echo count_users();?></strong>
            <span>渠道商</span>
        </dd>
        </a>
    </dl>
    <dl class="show-num-mod">
        <a href="<?php echo U('goods/index',array('status'=>2));?>">
        <dt><i class="count-icon user-action-icon"></i></dt>
        <dd>
            <strong><?php echo count_goods();?></strong>
            <span>商品数量</span>
        </dd>
        </a>
    </dl>
    <dl class="show-num-mod">
        ...
        <dd>
            <strong><?php echo count_orders();?></strong>
            <span>订单数</span>
        </dd>
        </a>
    </dl>
    <dl class="show-num-mod">
        ...
        <dt><i class="count-icon doc-count-icon"></i></dt>
        <dd>
            <strong><?php echo count_amount();?></strong>
            <span>交易总额</span>
        </dd>
        </a>
    </dl>
    <dl class="show-num-mod">
        ...
        <dd>
            <strong><?php echo count_agent_reward();?></strong>
            <span>渠道商提成</span>
        </dd>
        </a>
    </dl>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $('.copyright').html('<div class="copyright"> ©2017-2019 <a href="" target="_blank"></a>姑苏区厨源家电生活馆</div>');
        $('.sidebar').remove();
    })
</script>
