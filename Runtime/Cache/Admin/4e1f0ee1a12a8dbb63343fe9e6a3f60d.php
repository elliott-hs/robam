...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
             <input type="hidden" name="uid"  value="<?php echo ($user["id"]); ?>">
                <input type="text" class="text input-large" name="username" value="<?php echo ($user["username"]); ?>">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="email" value="<?php echo ($user["email"]); ?>">
            </div>
        </div>
        <div class="form-item">
