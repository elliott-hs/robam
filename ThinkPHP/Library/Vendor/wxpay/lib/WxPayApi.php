...
class WxPayApi
{
	...
	public static function notify($callback, &$msg)
	{
		...
		//file_put_contents("./log_4.txt", var_export($result, true));
...
curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,FALSE);
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, dirname(__DIR__).WxPayConfig::SSLCERT_PATH);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, dirname(__DIR__).WxPayConfig::SSLKEY_PATH);
		}
		//post提交方式
	 ...
	 * @throws WxPayException
	 */
	public static function postXmlCurl_by($xml, $url, $useCert = false, $second = 30)
	{		
		$ch = curl_init();
		//设置超时
		curl_setopt($ch, CURLOPT_TIMEOUT, $second);
...
curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,FALSE);
		...
		if($useCert == true){
			...
			//使用证书：cert 与 key 分别属于两个.pem文件
			curl_setopt($ch,CURLOPT_SSLCERTTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLCERT, '/home/app/sites/md/ThinkPHP/Library/Vendor/wxpay/cert/apiclient_cert.pem');
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, '/home/app/sites/md/ThinkPHP/Library/Vendor/wxpay/cert/apiclient_key.pem');
		}
		//post提交方式
		curl_setopt($ch, CURLOPT_POST, TRUE);
		curl_setopt($ch, CURLOPT_POSTFIELDS, $xml);
